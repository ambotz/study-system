...
- The Court does not reach the delegation question or the District Court's alternative holding that the Act "impermissibly disrupts the balance of powers."

**Rejected**

- *Congress deliberately chose this arrangement, and the President signed it.* "The fact that Congress intended such a result is of no moment." "Congress cannot alter the procedures set out in Article I, § 7, without amending the Constitution." Kennedy: "That a congressional cession of power is voluntary does not make it innocuous."
- *Cancellation is no greater than the President's long-standing, statutorily conferred discretion to decline to spend appropriated funds, going back to the First Congress's "sum[s] not exceeding" appropriations.* Stevens: "The critical difference ... is that unlike any of them, this Act gives the President the unilateral power to change the text of duly enacted statutes."
- *Presentment was fully satisfied, and the real question is whether Congress delegated too much, which it did not (Scalia).* Stevens declines the delegation debate: the historical briefing "illuminates the delegation issue but does not really bear on the narrow issue that is dispositive."
- *The Act violates no literal command: the President "simply followed the law," and a scheme that closely resembles an unconstitutional one is not therefore unconstitutional (Breyer).* The majority treats the resemblance as identity: in "legal and practical effect" the President repealed part of each Act.
- *The political branches are adjusting power between themselves, and no individual's liberty is at stake (Breyer).* Kennedy: "Liberty is always at stake when one or more of the branches seek to transgress the separation of powers."
...
The lineup inverts the usual pattern. Stevens, often a functionalist, writes a strictly formal opinion. Scalia, the Court's leading formalist and the author of a strong nondelegation dissent in [[Mistretta v. United States|Mistretta]], says the delegation doctrine "is preeminently not a doctrine of technicalities" and finds no violation. Breyer, the functionalist, argues from literalism with his speed-limit analogy and then from functional principles.
...
- The statute's own text defines the effect of cancellation: the item is prevented "from having legal force or effect." That is repeal.
- The two differences from the constitutional return: before enactment versus after, and whole bill versus part.
- Constitutional silence on post-enactment presidential repeal should be read as prohibition, because the § 7 procedure was "the product of the great debates and compromises that produced the Constitution itself."
- Washington's understanding: the President must "approve all the parts of a Bill, or reject it in toto."
- The three steps that made Public Law 105–33: House passage, Senate passage of "precisely the same text," and the President's signature. "If one paragraph of that text had been omitted at any one of those three stages, Public Law 105–33 would not have been validly enacted."
- The spending-discretion statutes are different in kind, because none "could even arguably have been construed to authorize" a change in statutory text.
- The decision "rests on the narrow ground that the procedures authorized by the Line Item Veto Act are not authorized by the Constitution."

**(Kennedy, J., concurring)**

- Breyer's premise that the political branches may freely reallocate their powers requires that the public good demands it and that liberty is not at risk. The first is "inadmissible": "The Constitution's structure requires a stability which transcends the convenience of the moment." The second is "flawed."
- Federalist 47: the accumulation of all powers in the same hands "may justly be pronounced the very definition of tyranny." The Framers thought structure so protective of liberty that they at first thought a Bill of Rights unnecessary.
- The Framers' liberty was political, secured by separation of powers and federalism, "quite in addition to the idea of freedom from intrusive governmental acts."
- The Act "gives the President the sole ability to hurt a group that is a visible target, in order to disfavor the group or to extract further concessions from Congress."
- "[O]ne Congress cannot yield up its own powers, much less those of other Congresses to follow. Abdication of responsibility is not part of the constitutional design."
- "The citizen has a vital interest in the regularity of the exercise of governmental power."

### Dissent / concurrence

**(Scalia, J., with O'Connor, J., and Breyer, J., as to Part III, concurring in part and dissenting in part)**

- Presentment was satisfied: the House and Senate passed the bill and the President signed it. The Court's problem is not a veto of part of a bill but cancellation of parts of an enacted law.
- A President cancelling a law without authorization would violate Article I. Cancelling under a law that authorizes cancellation was "certainly arguable" as an original matter, but the argument "has long since been made and rejected": the 1809 non-intercourse statute, Story in [[The Orono]], and the Tariff Act of 1890 upheld in [[Field v. Clark]].
- Article I, § 7 no more forbids authorized "Executive reduction" of congressional dispositions than it forbids authorized "Executive augmentation," "generally known as substantive rulemaking." The limits on both, perhaps "much more severe" for reduction, come from the nondelegation doctrine.
- On delegation, "there is not a dime's worth of difference between Congress's authorizing the President to cancel a spending item, and Congress's authorizing money to be spent on a particular item at the President's discretion." The history runs from the First Congress's lump-sum appropriations, through Jefferson's unspent $50,000 for fifteen gunboats, the Civil War and the Depression, to [[Cincinnati Soap Co. v. United States|Cincinnati Soap]].
- Impoundment without authorization is different: Nixon, "the Mahatma Gandhi of all impounders," was proved wrong in [[Train v. City of New York|Train]], which still confirmed that Congress may confer discretion to withhold.
- The Act's title "has succeeded in faking out the Supreme Court. The President's action it authorizes in fact is not a line-item veto and thus does not offend Art. I, § 7."
...
- Three background considerations. The goal, letting the President give effect to some but not all items of a massive bill, is legitimate. In 1789 Congress could simply have passed each appropriation as a separate bill; the entire first appropriations act was four sums "not exceeding" stated amounts. Today's budget is $1.5 trillion in bills of 500 pages, and Congress cannot split them into thousands of separate bills. The generally phrased structural provisions have been read "generously." And the Court need not "referee a dispute among the other two branches," citing Jackson's category one in [[Youngstown Sheet & Tube Co. v. Sawyer|Youngstown]].
...
- **The Post Roads Debate.** Sedgwick wanted Congress to set the principle and leave execution to the President. The Line Item Veto Act's findings (reduce the deficit, not impair essential functions, not harm the national interest) are that kind of principle. Madison would have seen cancellation as the blending of powers that erases the line of separation. See [[The Post Roads Debate]].
- **Don't overstate the holding.** The Court did not hold that the President may never decline to spend, or that the Act delegated too much. It held that a statutory power to cancel enacted provisions violates the Presentment Clause.
- **Memorable lines.** Stevens: "truncated versions of two bills." Scalia: "not a dime's worth of difference"; "the Mahatma Gandhi of all impounders"; "faking out the Supreme Court." Breyer: the 65-mile-per-hour speed limit; "skirts a constitutional edge." Kennedy: "Abdication of responsibility is not part of the constitutional design."
