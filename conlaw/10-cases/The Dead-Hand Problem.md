...
- **Jefferson to Madison, September 6, 1789.** "The earth belongs always to the living generation." No generation may bind the next; "every constitution, . . . and every law, naturally expires at the end of 19 years."
- **Madison's reply, February 4, 1790.** Frequent revision would bring "pernicious factions," and a government "so often revised" would be "too mutable to retain those prejudices in its favor which antiquity inspires."
- **Four answers the casebook sets out.**
  - Jeffersonian: each generation starts anew, and the case for starting again grows as the founding recedes.
...
- [[Constitutional themes and the dead hand]] — the justification question beneath every interpretive argument in the course.
- [[Types of Constitutional Argument]] — the next section.
- The Article V material in Class 26 — the Constitution's own answer to how the dead hand can be loosened.
