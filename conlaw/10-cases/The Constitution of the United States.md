...
The full text of the Constitution and its twenty-seven amendments, pp. 1–15 of the casebook, assigned on its own for the first class. The course is about the structure of government, so the provisions that do the work are in Articles I through VI. The amendments come in at the end of the quarter and in other courses.

The exam is closed-book and there are no devices in class, so the text has to be known well enough to quote the operative words.
...
- **Art. III, §§ 1–2: judicial power.** Good-behavior tenure and undiminished salary; the judicial power extends to enumerated "Cases" and "Controversies"; original and appellate jurisdiction, the latter "with such Exceptions, and under such Regulations as the Congress shall make" (Classes 11, 14 and 15).
- **Art. IV.** Full Faith and Credit; the Privileges and Immunities Clause (Class 25); the Territories Clause and the admission of new states (Class 12); the Guarantee Clause (Class 24).
...
- **Amendments that bear on structure.** The Tenth ("reserved to the States respectively, or to the people"); the Eleventh (state sovereign immunity); the Sixteenth (income tax, which removes the apportionment problem for direct taxes, Class 21); the Seventeenth (direct election of senators); the Twenty-fifth (presidential disability); and the Twenty-seventh (congressional pay, Class 26).
...
- Every module in the course. The operative clause of each belongs in that module's `authority` field.
