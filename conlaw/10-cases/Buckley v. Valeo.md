...
- **Labels do not control.** Congress called the FEC a legislative-branch body. The Court looked to the powers exercised. Compare [[Humphrey's Executor v. United States|Humphrey's Executor]], where the Court accepted Congress's description of the FTC as a "legislative or . . . judicial aid" and let that description decide the removal question. Be ready to say whether the two cases are consistent in method.
