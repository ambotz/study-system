...
kind: document
source: "Paulsen, McConnell, Bray & Baude (4th ed. 2021), pp. 326–328 (syllabus cites 5th ed. pp. 300–328)"
class: conlaw
session: 9
topic: "War powers — the Commander in Chief and war measures"
feeds_module:
...
Lincoln's two proclamations freeing slaves in the rebelling states: the Preliminary Emancipation Proclamation (released September 22, 1862) and the Final Emancipation Proclamation (January 1, 1863). The casebook opens "Conducting War" (Assignment 15) with them, asking what the President may do unilaterally once the war power has been invoked, what belongs to Congress, and when courts should intervene.

## What to notice

- **The stated source of power.** The Final Proclamation acts "by virtue of the power in me vested as Commander-in-Chief, of the Army and Navy of the United States in time of actual armed rebellion," and "as a fit and necessary war measure for suppressing said rebellion." Lincoln cites no statute as the source and no general executive power. The justification is the conduct of a war already under way, the power King's gloss at the Convention assigned to the Executive.
- **The preliminary proclamation states the war aim.** The war "will be prosecuted for the object of practically restoring the constitutional relation between the United States and the people" of the states in rebellion. Emancipation is presented as a means to that object, not an end independent of the war.
- **The 100-day warning.** On January 1, 1863, all persons held as slaves in any state or part of a state "the people whereof shall then be in rebellion" would be "then, thenceforward, and forever free." The delay gave rebelling states a chance to return; the war-measure theory requires that the measure operate against the enemy, and a state that ceased rebelling would cease to be enemy territory.
...
- **The geography is the argument (Note 2).** The Final Proclamation names the states in rebellion and excepts parishes of Louisiana, including New Orleans, the forty-eight counties of West Virginia, and several Virginia counties including Norfolk and Portsmouth, which "are for the present, left precisely as if this proclamation were not issued." It freed no slaves in the loyal border states (Kentucky, Maryland, Delaware, Missouri) or in areas already under Union control.
...
- **Why the Thirteenth Amendment was still needed.** Three reasons follow from the war-measure theory:
  ...
  - Duration: a war measure is tied to the war. [[Terminating War|Ludecke]] says war powers are "not exhausted when the shooting stops," but they are not permanent, and whether the proclamation's "forever free" survived peace was doubtful.
  - Revocability: an executive order can be revoked by a later President or countermanded, on one view, by Congress (Note 3). Only an amendment puts abolition beyond both.
- **Youngstown (Note 1).** "[I]n a legal sense this might be seen as a taking of property without consent. Isn't that the legal issue presented a century later in Youngstown?" The distinctions:
  - Outward versus inward. Truman seized American mills in a domestic labor dispute; Lincoln acted against enemy resources in enemy territory, which is the use of force against an enemy where Jackson gave the Commander in Chief his widest latitude.
  - Congressional will. Congress had rejected seizure before Truman acted (category three). The 1862 statutes pointed toward emancipation (category one or two).
  - Law of war. Capture or destruction of enemy resources is a recognized belligerent right; the Prize Cases upheld capture of enemy property at sea on the same premise. No law-of-war doctrine supported seizing steel mills from American owners.
