...
**Held** (5–4; Rehnquist, C.J., for the Court; Kennedy, J., with O'Connor, J., and Thomas, J., concurring)
...
- **Collective action (Note 4).** More than forty states already banned guns near schools; there was no interstate spillover the states could not solve. Contrast federal limits on interstate gun sales, which do respond to a collective-action problem. The Virginia Plan would have given Congress power where "the separate States are incompetent"; the Convention instead wrote an enumeration. Does the enumeration codify the collective-action principle or replace it?
